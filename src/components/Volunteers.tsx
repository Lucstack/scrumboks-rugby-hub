  ...
  const volunteerRoles = [
    {
      ...
      description:
        'Help bij het trainen van onze teams. Ervaring met rugby is welkom maar niet verplicht.',
    ...
    },
    {
      ...
      description:
        'Begeleid onze jongste spelers (6-12 jaar) tijdens trainingen en wedstrijden.',
    ...
    },
    {
      ...
      description:
        'Fluit wedstrijden en help bij het leren van de regels. Cursus wordt aangeboden.',
    ...
    },
    {
      ...
      title: 'Barcommissie',
      description:
        'Help bij het beheren van de kantine tijdens wedstrijden en evenementen.',
    ...
    },
    {
      ...
      description:
        'Organiseer clubactiviteiten, toernooien en sociale evenementen.',
      commitment: 'Variabel',
      level: 'Creatief',
      urgent: false,
    ...
    },
    {
      ...
      description:
        'Help met social media, website en communicatie naar leden en buitenwereld.',
      commitment: '1-2 uur per week',
      level: 'Online',
      urgent: false,
      color: 'from-scrumboks-blue to-scrumboks-blue-light',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-scrumboks-blue mb-4 flex items-center justify-center gap-3">
              <div className="w-8 h-8 bg-scrumboks-yellow rounded-full flex items-center justify-center">
                <span className="text-scrumboks-black font-bold text-sm">
                  !
                </span>
              </div>
              Dringend Gezocht
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {volunteerRoles
              .filter(role => role.urgent)
              .map((role, index) => (
                <Card
                  key={index}
                  className="border-0 shadow-soft hover:shadow-lg transition-all duration-300 group"
                >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-sm text-scrumboks-gray">
                            {role.level}
                          </span>
                        </div>
                      </div>
        ...
        <div className="text-center bg-gradient-to-r from-scrumboks-blue/5 to-scrumboks-yellow/5 p-12 rounded-2xl">
          ...
          <p className="text-scrumboks-gray mb-8 max-w-2xl mx-auto text-lg leading-relaxed">
            Elke bijdrage is welkom! Of je nu ervaring hebt of niet, we helpen
            je graag op weg. Samen maken we Scrumboks nog beter.
          </p>
