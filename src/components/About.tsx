...
const About = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="py-32 bg-gradient-to-b from-scrumboks-navy via-scrumboks-black/50 to-scrumboks-navy relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`text-center mb-20 ${isVisible ? 'animate-fade-up' : 'opacity-0'}`}>
          <div className="glass-gold rounded-3xl px-10 py-5 mb-8 inline-block">
            <span className="text-scrumboks-navy font-black text-xl tracking-wider">
              OVER DE SCRUMBOKS
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-24">
          ...
          <div className={`space-y-10 ${isVisible ? 'animate-slide-right' : 'opacity-0'}`}>
            <div className="glass-dark rounded-3xl p-8">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 bg-gradient-to-br from-scrumboks-gold to-scrumboks-gold rounded-2xl flex items-center justify-center">
                  <Shield className="w-8 h-8 text-scrumboks-navy" />
                </div>
                <h3 className="text-4xl font-black text-scrumboks-gold">
                  RUGBY COMMUNITY
                </h3>
              </div>
              ...
              <div className="glass-gold rounded-2xl p-6 border-2 border-scrumboks-gold/30">
                <p className="text-scrumboks-navy font-bold text-center text-lg italic">
                  "Bij de Scrumboks voel je meteen de warme sfeer. Een club waar rugby nog echt rugby is."
                </p>
                <p className="text-scrumboks-navy text-center text-sm mt-2 font-semibold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="glass-dark rounded-2xl p-6 card-3d group">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="text-4xl font-black text-scrumboks-gold group-hover:scale-110 transition-transform duration-300">
                    1976
                  </div>
                </div>
              ...
              <div className="glass-gold rounded-2xl p-6 card-3d group">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="text-4xl font-black text-scrumboks-navy group-hover:scale-110 transition-transform duration-300">
                    50+
                  </div>
                </div>
                <div className="text-scrumboks-navy font-bold text-lg">
                  LEDEN
                </div>
                <div className="text-scrumboks-navy/70 text-sm mt-1">
                  Actieve Spelers
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-6">
              <Link to="/membership">
                <Button
                  size="xl"
                  className="btn-hover-gradient text-scrumboks-navy font-black text-lg px-8 py-4 rounded-2xl border-2 border-scrumboks-gold/50 hover:border-scrumboks-gold shadow-2xl hover:shadow-gold/50 transform hover:scale-105 transition-all duration-300 group"
                >
              ...
              <Button
                size="xl"
                className="glass-dark text-scrumboks-gold font-bold text-lg px-8 py-4 rounded-2xl border-2 border-scrumboks-navy/50 hover:border-scrumboks-navy transition-all duration-300"
                onClick={() =>
                  document
                    .querySelector('#teams')
          ...
          <div className={`relative group ${isVisible ? 'animate-scale-in' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
            <div className="absolute -inset-6 bg-gradient-to-br from-scrumboks-gold/20 via-transparent to-scrumboks-navy/20 rounded-3xl opacity-60 group-hover:opacity-80 transition-opacity duration-500 blur-xl"></div>
            ...
            <div className="relative glass-dark rounded-3xl p-4 card-3d">
              ...
              <div className="absolute top-8 right-8 glass-gold rounded-2xl p-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-scrumboks-navy font-black text-sm">50 JAAR</span>
                </div>
              </div>
              
              {/* Quote */}
              <div className="absolute bottom-8 left-8 right-8 glass-dark rounded-2xl p-6">
                <p className="text-scrumboks-gold font-bold text-center text-lg">
            ...
            {values.map((value, index) => (
              <div key={index} className="group relative">
                <div className="glass-dark rounded-3xl p-8 h-full card-3d hover:bg-scrumboks-navy/20 transition-all duration-500">
                  <div className="w-20 h-20 bg-gradient-to-br from-scrumboks-gold to-scrumboks-gold rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                    <value.icon className="w-10 h-10 text-scrumboks-navy" />
                  </div>
                  
                  <h4 className="text-2xl font-black text-scrumboks-gold mb-4 text-center group-hover:text-scrumboks-white transition-colors duration-300">
                    {value.title}
                  </h4>
                ...
                {/* Subtle Glow */}
                <div className="absolute -inset-2 bg-gradient-to-br from-scrumboks-gold/5 to-scrumboks-navy/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 blur-lg"></div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center max-w-4xl mx-auto">
              <Link to="/volunteers" className="w-full sm:w-auto">
                <Button
                  size="xl"
                  className="w-full sm:w-auto glass-dark text-scrumboks-gold font-black text-xl px-10 py-6 rounded-2xl border-2 border-scrumboks-navy/50 hover:border-scrumboks-navy shadow-2xl hover:shadow-navy/50 transform hover:scale-105 transition-all duration-500 group"
                >
              ...
              <Link to="/sponsors" className="w-full sm:w-auto">
                <Button
                  size="xl"
                  className="w-full sm:w-auto btn-hover-gradient text-scrumboks-navy font-black text-xl px-10 py-6 rounded-2xl border-2 border-scrumboks-gold/50 hover:border-scrumboks-gold shadow-2xl hover:shadow-gold/50 transform hover:scale-105 transition-all duration-500 group"
                >
