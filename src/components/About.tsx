...
const About = () => {
  const values = [
    ...
    },
    {
      ...
      description: 'We koesteren onze geschiedenis en bouwen samen aan nieuwe herinneringen.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-block bg-scrumboks-yellow/10 border border-scrumboks-yellow/20 rounded-full px-6 py-2 mb-4">
            <span className="text-scrumboks-blue font-semibold">🏠 Ons verhaal</span>
          </div>
          ...
          <p className="text-lg lg:text-xl text-scrumboks-gray max-w-4xl mx-auto leading-relaxed">
            <span className="text-scrumboks-blue font-medium">Al 50 jaar</span> zijn we het kloppende hart van rugby in Tiel. 
            Hier schrijven we samen verhalen, smeden we vriendschappen voor het leven en 
            <span className="text-scrumboks-yellow font-medium"> vieren we elke kleine overwinning alsof het de wereldcup is.</span>
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-scrumboks-gray leading-relaxed mb-6 text-lg">
                <span className="text-scrumboks-blue font-medium">Scrumboks is geen gewone rugbyclub.</span> 
                We zijn een grote, warme familie die elkaar door dik en dun steunt. 
                Hier kennen we elkaar bij naam, vieren we elkaars successen en helpen we elkaar door moeilijke tijden.
              </p>
              <p className="text-scrumboks-gray leading-relaxed mb-6">
                <span className="text-scrumboks-yellow font-medium">Of je nu 5 jaar bent of 50+,</span> een absolute beginner of ervaren veteraan - 
                bij Scrumboks vind je jouw plek. We geloven dat rugby voor iedereen toegankelijk moet zijn.
              </p>
              <div className="bg-gradient-to-r from-scrumboks-blue/5 via-scrumboks-yellow/5 to-scrumboks-blue/5 p-6 rounded-2xl border border-scrumboks-blue/10">
                <p className="text-scrumboks-blue font-medium italic text-center">
                  "Bij Scrumboks draait het niet alleen om rugby spelen - het gaat om rugby beleven, 
                  vrienden maken en samen groeien als team én als mens."
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-scrumboks-blue/10 via-scrumboks-blue/5 to-transparent p-6 rounded-2xl shadow-soft group hover:shadow-lg transition-all duration-300">
                ...
                <div className="text-scrumboks-gray font-medium">Opgericht met liefde</div>
                <div className="text-sm text-scrumboks-gray/70 mt-1">50 jaar verhalen</div>
              </div>
              <div className="bg-gradient-to-br from-scrumboks-yellow/15 via-scrumboks-yellow/8 to-transparent p-6 rounded-2xl shadow-soft group hover:shadow-lg transition-all duration-300">
                ...
                <div className="text-scrumboks-gray font-medium">Familieleden</div>
                <div className="text-sm text-scrumboks-gray/70 mt-1">En groeiende!</div>
              </div>
            </div>
          ...
          <div className="relative group">
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-scrumboks-white/90 backdrop-blur-sm p-4 rounded-xl border border-scrumboks-white/50">
              <p className="text-scrumboks-blue font-medium text-sm text-center">
                💙 "Dit zijn de momenten waar we voor leven - samen vieren, samen groeien" 💛
              </p>
            </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-scrumboks-blue mb-4">
              <span className="text-scrumboks-yellow">❤️</span> Wat ons drijft <span className="text-scrumboks-yellow">❤️</span>
            </h3>
            <p className="text-scrumboks-gray max-w-2xl mx-auto">
              Deze waarden vormen de basis van wie we zijn en wat we samen opbouwen
            </p>
          </div>
        ...
        <div className="text-center bg-gradient-to-br from-scrumboks-blue/5 via-scrumboks-yellow/5 to-scrumboks-blue/5 p-12 rounded-3xl border border-scrumboks-blue/10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-scrumboks-gray mb-8 max-w-2xl mx-auto leading-relaxed">
              <span className="text-scrumboks-blue font-medium">Bij Scrumboks is er altijd een plekje voor jou.</span> 
              Of je nu wilt spelen, ondersteunen, vrijwilligerswerk doen of sponsoren - 
              <span className="text-scrumboks-yellow font-medium"> samen maken we onze club nog mooier!</span>
            </p>
