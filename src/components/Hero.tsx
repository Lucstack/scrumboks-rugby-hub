    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-oswald font-bold text-scrumboks-white leading-tight">
          ...
          <span className="block text-scrumboks-gold drop-shadow-lg">
            SAMEN PLEZIER
          </span>
        </h1>
        ...
        <p className="text-lg sm:text-xl lg:text-2xl text-scrumboks-white/90 max-w-4xl mx-auto leading-relaxed font-inter">
          ...
          <span className="text-scrumboks-gold font-medium"> Al 50 jaar</span>{' '}
        ...
        >
          <div className="flex items-center justify-center space-x-3">
            ...
            <div className="text-center">
              ...
              <p className="text-scrumboks-white/90 text-sm font-inter">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-12 max-w-4xl mx-auto">
          <div className="text-center">
            <div className="text-3xl lg:text-4xl font-oswald font-bold text-scrumboks-gold">
              50+
            </div>
            <div className="text-scrumboks-white/80 text-sm lg:text-base font-inter">
              Leden
            </div>
          </div>
          <div className="text-center">
