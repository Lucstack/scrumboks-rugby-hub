  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-scrumboks-dark/70 via-scrumboks-blue-dark/60 to-scrumboks-dark/80" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-scrumboks-white leading-tight">
            <span className="block">DE TOFSTE RUGBYCLUB</span>
            <span className="block text-scrumboks-yellow">VAN DE BETUWE</span>
          </h1>

          {/* Subheading */}
          <p className="text-lg sm:text-xl lg:text-2xl text-scrumboks-white/90 max-w-3xl mx-auto leading-relaxed">
            Sinds bijna 50 jaar dé plek waar rugbypassie en teamspirit samenkomen in Tiel. 
            Word onderdeel van onze hechte club en ervaar waarom rugby meer is dan een sport!
          </p>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-12 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-scrumboks-yellow">50</div>
            ...
            <div className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-scrumboks-yellow">50</div>
              <div className="text-scrumboks-white/80 text-sm lg:text-base">Jaar ervaring</div>
            </div>
            <div className="text-center">
